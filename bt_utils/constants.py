...
STAKE_INFO_BASE_FEE_RAO = 1061771   # 0.1 TAO tip used for MevShield announce_next_key (stake-info)
LIMIT_PRICE_BASE_FEE_RAO = 1061771  # 0.1 TAO tip used for MevShield announce_next_key (limit-price)
